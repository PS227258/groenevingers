...
class DymanticTokenSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('dymantic_instagram_feed_tokens')->insert([
            'id' => 1,
            'profile_id' => 1,
            'access_code' => 'IGQWRQQ0NobU5hb1JTbEwwckxmMUNva3VNNUNjTWduczB4NUVQc20zdUNraWphXzVnRUZAPRXRzTURxMzNQY2c3V3EzQXhyVzFjOGFpNUpNLUVqX0ZATTmphOG4xNXQyQ2NDRENUSU9FXzBVUQZDZD',
